# Tally Arbiter M5Stack AtomS3 Lite Listener

Tally Arbiter M5Stack AtomS3 Lite Listener is an accessory program that allows you to connect to a Tally Arbiter server and control an AtomS3 Lite device based on the incoming tally information.
